...
public class CapteurTemperatureEau extends CapteurEau {
    public CapteurTemperatureEau() {
    }

    public CapteurTemperatureEau(String id, String nom, StatutCapteur statut, Zone zone,
